...
#---Google Chat Webhook
export parent=spaces/AAAAPqXN4cI key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI token=Tp6L3yV_SRRi7p7RPr9cHTy78P_0Qbb8pFDNTy4kX3c%3D threadKey=webhook-beta
...
GCHAT_WEBHOOK_DATA='{
  "name": "'$CI_COMMIT_SHORT_SHA'-'$CI_PIPELINE_IID'", "text": "cleanup", "previewText": "preview", "fallbackText": "fallback", "argumentText": "argument",
  "cards": [
    {
          ...
          "widgets": [
            {
              "keyValue": {
                ...
                "bottomLabel": "Committer: '"$COMMITTER_NAME"'",
